// for non stop version, //

//#define OLD_VERSION 


// for faster (125/min) version, #define
  ...
  partial  class Form1
    {
        ...
        {
           if (setupForm.fname1 == null || File.Exists(setupForm.fname1))
           {
               MessageBox.Show("File not defined or already exists! Please setup again.");
               form.label7.Text = "Stopped";
               return 0;
           }

            string startTimeStr = "Start Time:" + DateTime.Now.ToString();
           ...
           // string defaultHostName = "188.198.1.1";
            string defaultHostName = "148.198.1.1";
           ...
           mForm = form; //Xinwei
            ...
            try
            {
...
#if !OLD_VERSION
                    string dataStr1 = tc.Read();
                    file.WriteLine(dataStr1);
#endif
                    int i = 1;
               ...
               //    Console.ReadKey(); // continue after reading a key from the keyboard.
                ...
                string endTimeStr = "End Time:" + DateTime.Now.ToString();
                file.WriteLine(startTimeStr);
                file.WriteLine(endTimeStr);

                string numSampleStr = " Total Samples: " + mEmData.mItemSize;
                file.WriteLine(numSampleStr);
